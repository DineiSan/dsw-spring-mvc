...
//	
	...
	public ModelAndView dadosPessoais() {
	 ...
	 mv.addObject("nome", "Valdinei Santana dos Reis");
	 mv.addObject("numeroTelefone", "(11)94886-3190");
	 mv.addObject("email", "valdinei.sreis@senacsp.edu.br");
	 mv.addObject("dataNascimento", "02/03/1994");
	 mv.addObject("linkedin", "https://www.linkedin.com/in/valdinei-santana-8675591b4/");
	 mv.addObject("gitHub", "https://github.com/DineiSan");
	 return mv;
	}
